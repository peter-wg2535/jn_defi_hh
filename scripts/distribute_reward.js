...
// const x_api_endpoint=process.env.TREASURY_KOVAN_CONTRACT_ADDRESS
// const treasury_contract_address=process.env.TREASURY_KOVAN_CONTRACT_ADDRESS

const x_api_endpoint=process.env.RINKEBY_ENDPOINT
const treasury_contract_address=TREASURY_RINKEBY_CONTRACT_ADDRESS
async function main() {
